...
@section('content')
    <div class="container mx-auto px-4 pt-8 text-justify leading-9 mb-8">
        ...
        <p>É concedida permissão para baixar temporariamente uma cópia dos materiais
            (informações ou software) no site FFilmes , apenas para visualização transitória pessoal e não comercial. Esta é
        ...
        <ol>
            ...
            <li>tentar descompilar ou fazer engenharia reversa de qualquer software contido
                no site FFilmes;&nbsp;</li>
        ...
        <p>Esta licença será automaticamente rescindida se você violar alguma dessas
            restrições e poderá ser rescindida por FFilmes a qualquer momento. Ao encerrar a visualização desses materiais
        ...
        <ol>
            <li>Os materiais no site da FFilmes são fornecidos 'como estão'. FFilmes não
            ...
            <li>Além disso, o FFilmes não garante ou faz qualquer representação relativa à
        ...
        <h2>4. Limitações</h2>
        <p>Em nenhum caso o FFilmes ou seus fornecedores serão responsáveis ​​por
            quaisquer danos (incluindo, sem limitação, danos por perda de dados ou lucro ou devido a interrupção dos
            negócios) decorrentes do uso ou da incapacidade de usar os materiais em FFilmes, mesmo que FFilmes ou um
            representante autorizado da FFilmes tenha sido notificado oralmente ou por escrito da possibilidade de tais
        ...
        <p>Os materiais exibidos no site da FFilmes podem incluir erros técnicos,
            tipográficos ou fotográficos. FFilmes não garante que qualquer material em seu site seja preciso, completo ou
            atual. FFilmes pode fazer alterações nos materiais contidos em seu site a qualquer momento, sem aviso prévio. No
            entanto, FFilmes não se compromete a atualizar os materiais.</p>
        <h2>6. Links</h2>
        <p>O FFilmes não analisou todos os sites vinculados ao seu site e não é
            responsável pelo conteúdo de nenhum site vinculado. A inclusão de qualquer link não implica endosso por FFilmes
            do site. O uso de qualquer site vinculado é por conta e risco do usuário.</p>
        <p><br></p>
        <h3>Modificações</h3>
        <p>O FFilmes pode revisar estes termos de serviço do site a qualquer momento, sem
        ...
        <p>Estes termos e condições são regidos e interpretados de acordo com as leis do
            FFilmes e você se submete irrevogavelmente à jurisdição exclusiva dos tribunais naquele estado ou
            localidade.</p>
    </div>
