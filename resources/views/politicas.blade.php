...
@section('content')
    <div class="container mx-auto px-4 pt-8 text-justify leading-9 mb-8">
        <h2 class="uppercase tracking-wider text-primary text-lg font-semibold mb-8">Política Privacidade</h2>
        <p>A sua privacidade é importante para nós. É política do FFilmes respeitar a sua
            privacidade em relação a qualquer informação sua que possamos coletar no site <a
                href="https://www.ffilmes.com.br">FFilmes</a>, e outros sites que possuímos e operamos.</p>
        ...
        <p>O nosso site pode ter links para sites externos que não são operados por nós.
            ...
            responsabilidade por suas respectivas políticas.</p>
        ...
        <p>O uso continuado de nosso site será considerado como aceitação de nossas
            ...
            dados do usuário e informações pessoais, entre em contacto connosco.</p>
        <p>
        <ul>
        ...
        <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que
            o FFilmes oferece no site e com caráter enunciativo, mas não limitativo:</p>
        <ul>
            ...
            <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica,
                166bet ou azar, qualquer tipo de pornografia ilegal, de apologia ao terrorismo ou contra os direitos
                humanos;
            </li>
            <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares)
                do FFilmes, de seus fornecedores ou terceiros, para introduzir ou disseminar vírus informáticos ou quaisquer
        ...
        <p>Esta política é efetiva a partir de&nbsp;30 April 2024 00:00</p>
    </div>
